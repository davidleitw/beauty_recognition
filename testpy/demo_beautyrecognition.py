...
Traindata_dir = r'~/Facenet-Real-time-face-recognition-using-Tensorflow/train_img'
Testdata_dir = r''
Model_dir = r''
Classifier = r''
Npy = r''
...
class Testing_tool(object):
    def __init__(train_dir, test_dir, model_dir, classifier, npy)
        ...
        self.testdata = [Img for Img in cv2.imread((self.testdata_imgname), 0)] # load the data
        self.test_analysis = []    
    ...
    def recognition_testdata(Image_show=True, Output_analysis=True):
